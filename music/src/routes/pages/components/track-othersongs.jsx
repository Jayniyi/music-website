...
import  Styles from  '../../../routes/pages/components/track-othersongs.module.css';
export default function otherSongs() {
  return (
    <div className={Styles.joo}>
      <div className={Styles.single_video}>
        <div className={Styles.thumb}>
          <img src={VideOne} alt="" />
        </div>
        <div className={Styles.hover_elements}>
